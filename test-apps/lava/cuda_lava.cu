...
//#define rad::checkFrameworkErrors(error) __rad::checkFrameworkErrors(error, __LINE__, __FILE__)
...
//void __rad::checkFrameworkErrors(cudaError_t error, int line, const char *file) {
