...
touch diff.log 
sed -n '1,9p;10q' ${APP_DIR}/golden_stderr.txt > new_golden_stderr.txt

sed -n '1,9p;10q' stderr.txt > tmp_stderr.txt 
...
diff tmp_stderr.txt new_golden_stderr.txt > stderr_diff.log
...
sed -n '1,1201p;1202q' stdout.txt > selected_output.txt 
#grep sum stdout.txt > selected_output.txt 
sed -n '1,1201p;1202q' ${APP_DIR}/golden_stdout.txt > selected_golden_output.txt 
