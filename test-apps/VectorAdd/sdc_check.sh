...
cp ${APP_DIR}/golden_stderr.txt new_golden_stderr.txt

touch tmp_stderr.txt 
...
sed -n '6,9477p;9477q' stdout.txt > selected_output.txt 
#grep sum stdout.txt > selected_output.txt 
sed -n '6,9477p;9477q' ${APP_DIR}/golden_stdout.txt > selected_golden_output.txt 
